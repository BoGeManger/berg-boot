...
public class SnowflakeIdWorker {
	...
	@Autowired
	private SnowflakeIdWorker idWorkerIoc;

	@PostConstruct
	public void init(){
		idWorker = this.idWorkerIoc;
        log.info("初始化SnowflakeIdWorker --> workerId:"+idWorker.workerId+",datacenterId:"+idWorker.datacenterId);
    }
