 ...
 * the License.
 */
package com.berg.generator.config.builder;

import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.berg.generator.InjectionConfig;
import com.berg.generator.config.*;
import com.berg.generator.config.po.TableField;
import com.berg.generator.config.po.TableFill;
import com.berg.generator.config.po.TableInfo;
import com.berg.generator.config.querys.H2Query;
...
public class ConfigBuilder {
    ...
    public com.berg.generator.config.builder.ConfigBuilder setTableInfoList(List<TableInfo> tableInfoList) {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.EDIT_VO, joinPackage(config.getParent(), config.getEditVo()));
        packageInfo.put(ConstVal.PAGE_IN_VO, joinPackage(config.getParent(), config.getPageInVo()));
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getEditVo(), outputDir, ConstVal.EDIT_VO_PATH, ConstVal.EDIT_VO);
            setPathInfo(pathInfo, template.getPageInVo(), outputDir, ConstVal.PAGE_IN_VO_PATH, ConstVal.PAGE_IN_VO);
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            tableInfo.setDs(globalConfig.getDs());
            tableInfo.setParentModuleName(globalConfig.getParentModuleName());
            String entityName;
            ...
            tableInfo.setEntityNameVariable(NamingStrategy.smallLetterFirst(tableInfo.getEntityName()));
            ...
            tableInfo.setServiceNameVariable(NamingStrategy.smallLetterFirst(tableInfo.getServiceName()));
            ...
            if (StringUtils.isNotBlank(globalConfig.getEditVoName())) {
                tableInfo.setEditVoName(String.format(globalConfig.getEditVoName(), entityName));
            } else {
                tableInfo.setEditVoName(entityName + ConstVal.EDIT_VO);
            }
            if (StringUtils.isNotBlank(globalConfig.getPageInVoName())) {
                tableInfo.setPageInVoName(String.format(globalConfig.getPageInVoName(), entityName));
            } else {
                tableInfo.setPageInVoName(entityName + ConstVal.PAGE_IN_VO);
            }
            ...
            tableInfo.setDaoNmaeVariable(NamingStrategy.smallLetterFirst(tableInfo.getDaoName()));
        ...
        try {
            ...
            try (
                ...
                while (results.next()) {
                    ...
                    //处理必填(目前只处理mysql和postgresql两种数据库)
                    field.setRequired(dbQuery.isRequired(results));
                    fieldList.add(field);
                }
            }
        } catch (SQLException e) {
    ...
    public com.berg.generator.config.builder.ConfigBuilder setStrategyConfig(StrategyConfig strategyConfig) {
        this.strategyConfig = strategyConfig;
        return this;
    }
    ...
    public com.berg.generator.config.builder.ConfigBuilder setGlobalConfig(GlobalConfig globalConfig) {
        this.globalConfig = globalConfig;
        return this;
    }
    ...
    public com.berg.generator.config.builder.ConfigBuilder setInjectionConfig(InjectionConfig injectionConfig) {
