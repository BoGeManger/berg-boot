...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统组件表' ROW_FORMAT = Dynamic;
...
PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统路由表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for sys_test_tbl
-- ----------------------------
DROP TABLE IF EXISTS `sys_test_tbl`;
CREATE TABLE `sys_test_tbl`  (
