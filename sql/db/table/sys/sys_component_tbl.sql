...
`component` varchar(100) DEFAULT NULL COMMENT ' 前端绑定组件',
`path` varchar(255) DEFAULT NULL COMMENT '对应路由地址',
`icon` varchar(50) DEFAULT NULL COMMENT '图标',
`remark` varchar(255) DEFAULT NULL COMMENT '组件描述',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='系统组件表';